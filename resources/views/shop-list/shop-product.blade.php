                    ...
                    <div class="row">
                        <div class="product__discount__slider owl-carousel">
                             {{-- @if ($products->product_images)
                                @foreach ($products->product_images as $product)
                            <div class="col-lg-4">
                                        
                                
                                <div class="product__discount__item">
                                    <div class="product__discount__item__pic set-bg"
                                    data-setbg="{{ $products->product_images->url}}">
                                    ...
                                    <div class="product__discount__item__text">
                                        ...
                                        <h5><a href="{{ route('shop.show',$product->id) }}" style="color: blue"></a></h5>
                                        <div class="product__item__price"> <span>$36.00</span></div>
                                    </div>
                                </div>
                            </div> 
