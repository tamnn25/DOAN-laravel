                                ...
                                <div class="col-4">
                                    <div class="flex-container">
                                        <div class="flex-item">
                                            ...
                                            @guest
                                            <div class="dropdown">
                                                <button class=" dropdown-toggle" style="background-color:#0e79ec;     border-radius: 66%; color: white;border-color: white;" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
